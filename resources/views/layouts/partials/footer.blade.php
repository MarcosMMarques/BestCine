<footer class="bg-gray-900 text-gray-200 py-10 mt-10">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-8">
    <div class="flex items-center gap-4">
      ...
      <div>
        <span class="font-bold text-lg">Best Cine</span>
        <p class="text-sm text-gray-400">Your movie experience, redefined.</p>
      </div>
    </div>
    <div class="flex flex-col items-center md:items-end gap-2">
      <span class="font-semibold text-base mb-2">Follow us</span>
      <div class="flex gap-4">
        ...
        <a href="#" class="hover:text-pink-500 transition-colors" aria-label="YouTube">
          <svg fill="currentColor" viewBox="0 0 24 24" class="w-6 h-6">
  ...
  <div class="mt-8 text-center text-gray-500 text-xs">
    &copy; {{ date('Y') }} Best Cine. All rights reserved.
  </div>
</footer>
